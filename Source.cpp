...
int main()
{
    ...
    Cube A(3);
    A.Print();
    cout << "\nSurface area of cube is: " << A.SurfaceArea() << endl;

    cout << "Ball:" << endl;
    Ball B(4);
    B.Print();
    cout << "\nSurface area of ball is: " << B.SurfaceArea() << endl;

    cout << "Tetrahedron:" << endl;
    Tetrahedron C(3);
    C.Print();
    cout << "\nSurface area of tetrahedron is: " << C.SurfaceArea() << endl;

    cout << "Parallelepiped:" << endl;
    Parallelepiped D(2,3,4);
    D.Print();
    cout << "\nSurface area of tetrahedron is: " << D.SurfaceArea() << endl;
